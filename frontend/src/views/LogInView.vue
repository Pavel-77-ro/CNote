...
const question = "Don't have an account yet?";
...
<template>
  <section class="h-svh w-svw flex items-center justify-center bg-gradient-to-br from-gray-300 via-gray-200 via-[20%] to-orange-400">
    ...
    <div class="w-5/6 sm:w-3/5 lg:w-1/2 h-[600px] rounded-2xl shadowed flex overflow-hidden bg-slate-50">
      <div class="hidden sm:flex h-full text-gray-100 flex-[1] items-center justify-center bg-gray-900 flex-col gap-6">
        <h2 class="text-xl lg:text-3xl font-semibold text-gray-100 text-center">Welcome back!</h2>
        <p class="text-md lg:text-xl px-6 text-center text-gray-300">
          Log into your account and keep working on your notes!
        </p>
      </div>
      <FormCard
        :title="title"
